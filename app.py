...
drive_files = {
    "breast_cancer_model_last_v2.keras": "1mEseqUJuC4d7s4iD4fg7iuF6KiDN5pyL",
...
breast_model = keras.models.load_model(os.path.join(MODEL_DIR, "breast_cancer_model_last_v2.keras"))
